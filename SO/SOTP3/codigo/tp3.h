...
#define TAG_REQUEST           60	/* srv -> srv */ //Creamos algunos TAGs más para la exclusión y para la terminación.
#define TAG_REPLY             70	/* srv -> srv */
#define TAG_TERMINE_SERV      80	/* srv -> srv */
...
typedef struct {
    int caracter;
    int cant_iteraciones; //cantidad de iteraciones a imprimir el caracter
