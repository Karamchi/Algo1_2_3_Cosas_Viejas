...
class Pelicula {
 public:
  ...
  //void sinRepetidos(Lista<string> &l);
 ...
 private:
  ...
  bool es3D_;
  //void limpiaListasPel(Lista <std::pair<Genero ,Lista<Pelicula> > > &L);
  //void sinRepetidosA(Lista<Actor> &l);
  //void sinRepetidosG(Lista<Genero> &l);
};
